defmodule NicetiesWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NicetiesWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NicetiesWeb.Gettext, "errors", msg, opts)
    end
  end
